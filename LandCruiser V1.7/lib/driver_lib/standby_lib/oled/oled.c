...
//ÏÔÊ¾Ò»¸ö×Ö·ûºÅ´®
//Min: Char_Size = 12 ,Max: Char_Size = 16, Ò»¸ö×Ö·ûÕ¼8¸öÏñËØµã(ºáÏò)
...
{ 	
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;	//ËÙ¶È50MHz
 	GPIO_Init(OLED_PORT, &GPIO_InitStructure);	 		 //³õÊ¼»¯GPIOD6,7
 	GPIO_SetBits(OLED_PORT, OLED_SCL_PIN | OLED_SDA_PIN);	//PD7,PD6 Êä³ö¸ß
...
{	
	...
	NVIC_Configuration(); 	 //ÉèÖÃNVICÖÐ¶Ï·Ö×é2:2Î»ÇÀÕ¼ÓÅÏÈ¼¶£¬2Î»ÏìÓ¦ÓÅÏÈ¼¶ 	LED_Init();			     //LED¶Ë¿Ú³õÊ¼»¯
